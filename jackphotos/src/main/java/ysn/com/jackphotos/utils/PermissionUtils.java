...
public class PermissionUtils {
    ...
    public static void requestWriteExternalPermission(Activity activity) {
        requestPermission(activity, JackConstant.PERMISSION_REQUEST_CODE_WRITE_EXTERNAL, Manifest.permission.WRITE_EXTERNAL_STORAGE);
    }
    ...
    public static void requestCameraPermission(Activity activity) {
        requestPermission(activity, JackConstant.PERMISSION_REQUEST_CODE_CAMERA, Manifest.permission.CAMERA);
    }
    ...
    public static void requestWriteExternalAndCameraPermission(Activity activity) {
        requestPermission(activity, JackConstant.PERMISSION_REQUEST_CODE_WRITE_EXTERNAL_AND_CAMERA,

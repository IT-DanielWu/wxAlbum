...
public class Album implements Parcelable {
    ...
    public Album(String filePath, String thumbnails, Uri thumbnailsUri) {
        this.filePath = filePath;
        this.thumbnails = thumbnails;
        this.thumbnailsUri = thumbnailsUri;
    }

    public Album(String filePath, long time, String name, String mimeType, String thumbnails, Uri thumbnailsUri) {
        this.filePath = filePath;
        this.time = time;
        this.name = name;
    ...
    public Album(String filePath, long time, long duration, String name, String mimeType, String thumbnails,
                 Uri thumbnailsUri) {
        this.filePath = filePath;
        this.time = time;
